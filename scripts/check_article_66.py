...
def check_article_66():
    ...
    try:
        ...
        # 检查文章66
        cursor.execute('SELECT title, content, language, is_processed FROM news_articles WHERE id = 66')
        ...
        if result:
            ...
            # 检查AI处理结果
            cursor.execute('SELECT summary_zh, summary_en, translation_zh FROM processed_content WHERE article_id = 66')
